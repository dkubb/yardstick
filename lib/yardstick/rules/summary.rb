...
module Yardstick
  module Rules
    ...
    class Summary
      ...
      #
      class Presence < Rule
        self.description = 'method summary should be specified'.freeze
      ...
      class Length < Rule
        ...
        self.description = 'method summary should be less than or equal to 79 characters in length'.freeze
      ...
      class Delimiter < Rule
        self.description = 'method summary should not end in a period'.freeze
      ...
      class SingleLine < Rule
        ...
        self.description = 'method summary should be a single line'.freeze
